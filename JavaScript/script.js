...
d3.select("body").append('p').attr("href", "https://thomashoed.github.io/DataProcessing/Homework/Week3/index.html").text("Week 3");
d3.select("body").append('p').attr("href", "https://thomashoed.github.io/DataProcessing/Homework/Week4/index.html").text("Week 4");
